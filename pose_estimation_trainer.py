...
from utils.hrnet_utils.losses import JointsNLLLoss

# Imports from hrnet (should be after RPN imports)
import hrnet.tools._init_paths as _init_paths
from hrnet.lib.config import cfg
from hrnet.lib.config import update_config
from hrnet.lib.core.loss import JointsMSELoss
from hrnet.lib.core.function import train
from hrnet.lib.core.function import validate
from hrnet.lib.utils.utils import get_optimizer
from hrnet.lib.utils.utils import save_checkpoint
from hrnet.lib.utils.utils import create_logger
from hrnet.lib.utils.utils import get_model_summary

import hrnet.lib.dataset as dataset
...
def main():
    ...
    shutil.copy2(
        os.path.join(this_dir, 'hrnet_pkg/hrnet/lib/models', cfg.MODEL.NAME + '.py'),
        final_output_dir)
    ...
    #    criterion(outputs, target, target_weight)
    #    break
    #return
